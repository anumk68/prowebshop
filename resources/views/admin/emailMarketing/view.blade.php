            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Email Marketing Packages
                            <a href="{{ route('create-emailMarketing') }}" style="float: inline-end"><button
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody id="cate">
                                    @foreach ($emailMarketing as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('create-emailMarketing', $item->id) }}"
                                                        class="btn btn-info btn-sm mx-2"> <i class="fa fa-edit"
                                                            style="font-size:20px;color:#fff;"></i></a>
                                                    <form action="{{ route('updateStatus-emailMarketing', $item->id) }}" method="post"
