            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Wix Development Packages
                            <a href="{{ route('create-wix') }}" style="float: inline-end"><button
