            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Graphic Design Packages
                            <a href="{{ route('create-graphic') }}" style="float: inline-end"><button
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('create-graphic', $item->id) }}"
                                                        class="btn btn-info btn-sm mx-2"> <i class="fa fa-edit"
                                                            style="font-size:20px;color:#fff;"></i></a>
                                                    <form action="{{ route('updateStatus-graphic', $item->id) }}" method="post"
