            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Custom Development Packages
                            <a href="{{ route('create-custom') }}" style="float: inline-end"><button
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody id="cate">
                                    @foreach ($customDevelopment as $item)
                                        <tr>
